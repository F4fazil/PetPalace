...
class _ChatScreenState extends State<ChatScreen> {
      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            List<String> userIds =
                List<String>.from(chatRoomDoc["participants"]);
                      ...
                      trailing:
                          chatRoomDoc['unread_messages'][currentUserId] != 0
                              ? CircleAvatar(
                                  radius: 15,
                                  backgroundColor:
                                      const Color.fromARGB(255, 11, 220, 147),
                                  child: Text(
  ...
  Future<void> resetUnreadMessages(
      String currentuserUid, String otherUserId) async {
