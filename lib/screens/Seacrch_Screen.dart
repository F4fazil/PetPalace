 ...
 void showTrackingDialog(BuildContext context) {
  ...
  try {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text("Failed to load location data: ${e.toString()}")),
    );
  }
}
      ...
      body: StreamBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
         if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            Future.delayed(Duration.zero, closeTrackingDialog); // Close dialog when data is ready
          }
              ...
              children: [
                GoogleMap(
                  ...
                  initialCameraPosition:
                      const CameraPosition(target: _googlePlex, zoom: 16),
          ...
          return Center(
            child: CircularProgressIndicator(
                color: const Color.fromARGB(255, 17, 160, 141)),
          );
        },
      ),
