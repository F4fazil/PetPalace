...
import 'package:propertypall/admin_panel/SameBreed_admin.dart';
import 'package:propertypall/chat_service/chat_screen.dart';
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                  ...
                  borderSide:
                      const BorderSide(color: Color(0Xff66cdaa), width: 0.7),
                ),
          ...
          Expanded(
            child: StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                final pets = snapshot.data!.where((pet) {
                  final name = pet['pet_name']?.toString().toLowerCase() ?? '';
                  final breed =
                ...
                return GridView.builder(
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    ...
                    childAspectRatio: screenWidth > 600 ? 0.9 : 0.8, // Responsive aspect ratio
                  ),
                  padding: EdgeInsets.all(screenWidth * 0.04), // Responsive padding
...
class PetCard extends StatelessWidget {
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.network(
                    pet['profileImage'] ?? 'https://via.placeholder.com/150', // Default placeholder
                    ...
                    errorBuilder: (context, error, stackTrace) {
                      return Container(
                        ...
                        child: const Icon(Icons.pets, color: Colors.white, size: 50), // Pet icon
                      );
                    },
                  ),
                ),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: ElevatedButton.icon(
                      onPressed: () {
                        _navigateToChatScreen(context, pet['uid'] ?? '', "Chat");
                      },
  ...
  void _navigateToChatScreen(BuildContext context, String receiverId, String name) {
    Navigator.push(
      context,
      MaterialPageRoute(
