...
import 'package:propertypall/admin_panel/PetSitter_admin_panel/Petsitter_admin.dart';
import 'package:propertypall/chat_service/chat_screen.dart';
import 'package:propertypall/chat_service/chat_service.dart';
    ...
    child: StreamBuilder<List<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return const Center(
            child: Text('No pet sitters found.'),
          );
        }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final cardColor = containerColors[index % containerColors.length]; // Cycle through colors
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 40,
                          backgroundImage:
                              NetworkImage(sitter["profileImage"]),
                        ),
                          ...
                          child: Column(
                            ...
                            child: Row(
                              ...
                              Text(
                                ...
                                style: const TextStyle(
                                  color: Colors.white70, // Adjust text color for contrast
                                  fontSize: 14,
                                ),
                              ),
                            ],
                    ...
                    Align(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        style: ElevatedButton.styleFrom(
                          ...
                          foregroundColor: cardColor, // Use cardColor for button text
                          shape: RoundedRectangleBorder(
