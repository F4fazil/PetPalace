  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: SingleChildScrollView(
          child: Container(
            margin: const EdgeInsets.only(left: 20, right: 20, bottom: 10), // Add margin from left, right, and bottom
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(30), // Ensures the BottomNavigationBar is also rounded
