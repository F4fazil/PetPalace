...
import 'package:propertypall/screens/feature_screens/buy_and_sell.dart';
import 'package:propertypall/screens/feature_screens/sameBreedScreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
              ...
              child: Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final secondItem = (index * 2 + 1 < categories.length)
  ...
  void _handleCategoryTap(BuildContext context, String category) {
    if (category == 'Consult a Vet') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ConsultVetScreen()),
      );
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) =>  BreedConnectScreen()),
      );
    } else {
