...
class _ScheduleMeetingBottomSheetState extends State<_ScheduleMeetingBottomSheet> {
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Text(
                selectedDate != null
                    ...
                    : 'Select Date',
                style: const TextStyle(fontSize: 16, color: Color.fromARGB(255, 41, 116, 112)),
              ),
              ElevatedButton(
                onPressed: _pickDate,
                child: const Text('Pick Date', style: TextStyle(color: Color.fromARGB(255, 41, 116, 112))),
              ),
            ],
          ),
          const SizedBox(height: 16),
          Row(
            ...
            children: [
              Text(
                selectedTime != null ? 'Time: ${selectedTime!.format(context)}' : 'Select Time',
                style: const TextStyle(fontSize: 16, color: Color.fromARGB(255, 41, 116, 112)),
              ),
              ElevatedButton(
                onPressed: _pickTime,
                child: const Text('Pick Time', style: TextStyle(color: Color.fromARGB(255, 41, 116, 112))),
              ),
            ],
          ),
          const SizedBox(height: 16),
          ElevatedButton(
            ...
            child: const Text('Confirm Schedule', style: TextStyle(color: Color.fromARGB(255, 41, 116, 112))),
          ),
        ],
      ),
    );
