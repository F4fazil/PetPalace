...
class _CallPageState extends State<CallPage> {
  ...
  final String token =
      "007eJxTYAitXnB0SbuDzer3BWyP7go5pP1Ruid+x5XtTdrDmylPPT8qMJiYGSQlmZgkmyamGZkYpRgmGqSZWVgaGKeYGhuamRgaM6fOTW8IZGRQruZmYIRCEJ+ZoSC1hIEBAGSjHpQ=";
  ...
  Future<void> initAgora() async {
    ...
    _engine.registerEventHandler(RtcEngineEventHandler(
      onJoinChannelSuccess: (RtcConnection connection, int elapsed) {
        ...
        LocalNotification().showNotification("Video Call", "PetPalace", "");
      },
